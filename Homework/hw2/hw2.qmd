...
```{python}
#| label: alcohol-datas-web-scraping
#| message: false
#| warning: false
...
```{python}
#| label: alcohol-data-footnotes-removal-and-adjust-data-types
#| message: false
#| warning: false
...
```{python}
#| label: alcohol-data-inspect-missing-values
#| message: false
#| warning: false
