...
The OLS regression confirm several of these finding in EDA. GDP per capita, forest area percentage, renewable energy share, and urban population share are statistically significant predictors of carbon dioxide emissions per capita. Fossil electricity share is not statistically significant with a high p-value. The model explains `{python} float(round(linear_mod.rsquared_adj * 100, 2))`% of the variation in log carbon dioxide emissions per capita.
